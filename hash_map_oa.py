...
class HashMap:
    ...
    def put(self, key: str, value: object) -> None:
        ...
        entry, probe_i = self.quadratic_probe_insert(key)
    ...
    def get(self, key: str) -> object:
        ...
        TODO: Write this implementation
        """
        entry = self.quadratic_probe_search(key)
        if entry is None or entry.is_tombstone:
            return None
        elif entry.key == key:
            return entry.value
    ...
    def quadratic_probe_insert(self, key: object) -> (object, int):
    ...
    def quadratic_probe_search(self, key: object) -> object:
        initial_i, j = self._hash_function(key) % self._capacity, 0
        probe_i = (initial_i + j ** 2) % self._capacity
        node = self._buckets[probe_i]
